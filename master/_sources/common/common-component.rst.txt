...
**ゾーン - コンポーネント種別**
    1 対 1 で対応します（対応表は :numref:`zone-section` の :numref:`zone-component` を参照）。
**スクリプト一覧：あり**
    種別（例：キャラクター／フォグ／切札）は、共通項目（ **ゾーン** / **ユニット条件** ）に加えて、種別の **固有項目** と **スクリプト一覧** を示します。
**スクリプト一覧：なし**
...
ラベル
 キャラクターに付与された属性を示します。<速攻> や <攻撃> など様々なラベルがあります。
 ラベルは<>で括り記載されます。
