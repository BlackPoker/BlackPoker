...
2. 任意ルール（フォーマット／フレーム依存）
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

本章の項目は、プロジェクトやルールセットごとに導入を検討してください。

2.1 アクション名は「動詞＋名詞」で統一
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
