...
そのうえで、切札、レアカード、シナリオ手札（旧称：ストラテジー）などを選ぶことで、対戦の展開や戦略性を変えることができます。
...
シナリオ手札とは、シナリオ構築で選ばれるカード群です。
通常の手札とは異なり、手札領域には含まれません。
シナリオ手札の使い方は、使用するフレームごとに定義されます。

第9.1版では、従来「ストラテジー」と呼んでいた要素を、シナリオ構築との関係が分かりやすくなるように「シナリオ手札（旧称：ストラテジー）」として整理します。

シナリオ手札は通常の手札ではないため、手札枚数の上限や、通常の手札を参照する効果（ハンデス、手札を捨てるコストなど）には含めません。
ただし、個別のフレームで特別な扱いが定義されている場合は、その定義に従います。
