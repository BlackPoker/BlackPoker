...
\hrule height 0.5mm depth 0mm width 66.5mm %罫線
\vspace{1mm} %余白追加
#if((${arg0} == "lite") && (${row.lite.trim()} != "") && (${row.std.trim()} != ""))
{\small\bf ■ ${row.actName} {\scriptsize (${row.actType}) }} %Actionタイトル
#elseif((${row.lite.trim()} != "") && (${row.std.trim()} != ""))
...
\vspace{1mm} %余白追加
#if((${arg0} == "lite") && (${row.lite.trim()} != "") && (${row.std.trim()} != ""))
{\small\bf ■ ${row.charName} {\scriptsize (${row.type}) }} %Characterタイトル
#elseif((${row.lite.trim()} != "") && (${row.std.trim()} != ""))
{\small\bf ■ ${row.charName} {\scriptsize (${row.type}) [lite]}} %Characterタイトル
#elseif(${row.std.trim()} != "")
{\small\bf ○ ${row.charName} {\scriptsize (${row.type}) [std]}} %Characterタイトル
#elseif(${row.format.contains('pro')})
{\small\bf ◎ ${row.accharNametName} {\scriptsize (${row.type}) [pro]}} %Actionタイトル
#end
\hfill 
#if(${row.charKey.trim()} != "")
