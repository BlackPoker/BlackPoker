...
import com.github.blackpoker.actionlist.RstFn;
...
public class RstWriter implements Writer {
	...
	public void write(Map<String, Object> map, String outPath, String templateName) throws IOException {
		...
		try {
			...
			// TexFnを設定
			context.put("rstFn",new RstFn());

			StringWriter sw = new StringWriter();
			// テンプレートの作成
			Template template = Velocity.getTemplate(templateName+".rst.vm", "UTF-8");
			// テンプレートとマージ
