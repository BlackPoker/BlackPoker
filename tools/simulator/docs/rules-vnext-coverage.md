...
| :--- | :--- | :--- | :--- | :---: | :---: | :---: | :---: | :--- | :---: |
| `end` | エンド | `action.end` | `act.yaml` | 完了 | OK | あり | あり | エンドアクションの解決によるフォグ除去と、ターン・チャンス交代を実装完了 | - |
...
| **エンド処理** | `公式ルール本文` | 最小実装済み | あり | あり | エンドアクション（action.end）の解決に伴い、手番プレイヤーに付与されているフォグをすべて自動除去してサイズ計算を復元するクリーンアップを最小実装 | **高** |
