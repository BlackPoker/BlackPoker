...
export const PassAndPlayOverlay: React.FC<PassAndPlayOverlayProps> = ({
  ...
  return (
    ...
    >
      <div
        className="flex flex-col items-center max-w-md w-full p-6 bg-[#121216] rounded-2xl shadow-2xl border border-zinc-600 text-center animate-in fade-in zoom-in-95 duration-200"
        role="dialog"
        aria-modal="true"
      >
        <div className="w-12 h-12 rounded-full bg-zinc-900 border border-zinc-700 flex items-center justify-center text-xl text-white mb-3 shadow-inner">
          ★
        </div>

        <h2 className="text-xl font-serif font-black text-white mb-1.5 tracking-wide">
