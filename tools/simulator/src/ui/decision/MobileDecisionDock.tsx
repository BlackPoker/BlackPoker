...
export const MobileDecisionDock: React.FC<MobileDecisionDockProps> = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-zinc-300 shadow-2xl p-2 pb-[max(0.75rem,env(safe-area-inset-bottom))] lg:hidden">
      <div className="max-w-md mx-auto flex flex-col gap-1.5">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <span>{isEffectResolution ? "効果・割当てを選択 📋" : "行動を選ぶ ⚡"}</span>
          </button>
        </div>
      </div>
    </div>
