(() => { function dom_loaded() {
    ...
    function updateSidebarAttributesVisible() {
        sidebar_button.setAttribute('title', "サイドバーをたたむ");
        sidebar_button.setAttribute('aria-label', "サイドバーをたたむ");
    ...
    function updateSidebarAttributesHidden() {
        sidebar_button.setAttribute('title', "サイドバーを展開");
        sidebar_button.setAttribute('aria-label', "サイドバーを展開");
