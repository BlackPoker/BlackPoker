...
誘発したアクションをコントローラーのプレイヤー毎にリストにまとめます。
...
------------------------------------------------------------------------------------------------------------------------
[10-3]プレイヤー毎に誘発リストの即時効果のアクションを解決
------------------------------------------------------------------------------------------------------------------------
プレイヤー毎に誘発リストの即時効果のアクションを解決を行います。
順番はターンプレイヤーからターンが回る順にプレイヤー毎に行います。

------------------------------------------------------------
[10-4]誘発リストから即時効果のアクションを1つ取り出す
------------------------------------------------------------
順番のプレイヤーは、 プレイヤー毎の誘発リストから1つ即時効果のアクションを取り出します。
取り出すアクションは任意に選択できます。
...
------------------------------
勝敗を判定します。
詳しくは :numref:`_winlose` 参照。

--------------------------------------------------
[10-7]誘発したアクションをプレイヤー毎の誘発リストに追加
--------------------------------------------------
全てのプレイヤー、コンポーネントが持っている誘発型能力を確認します。 
誘発したアクションをコントローラーに応じてプレイヤー毎の誘発リストに追加します。


--------------------------------------------------
[10-8]未解決の即時効果があれば繰り返す
--------------------------------------------------
順番のプレイヤーの誘発リストに未解決の即時効果がある場合、
即時効果の解決を繰返します。

--------------------------------------------------
[10-9]誘発リストに即時効果のアクションがあれば繰り返す
--------------------------------------------------
プレイヤー毎の誘発リストに未解決の即時効果を持つアクションがある場合、
再びプレイヤー毎に誘発リストの即時効果の解決を繰返します。

--------------------------------------------------
[10-10]プレイヤー毎に通常効果\nのアクションをステージに追加
--------------------------------------------------
プレイヤー毎に誘発リストの通常効果のアクションをステージに追加します。
順番はターンプレイヤーからターンが回る順にプレイヤー毎に行います。
...
--------------------------------------------------
[10-12]誘発したアクションをプレイヤー毎の誘発リストに追加
--------------------------------------------------
全てのプレイヤー、コンポーネントが持っている誘発型能力を確認します。 
誘発したアクションをコントローラーに応じてプレイヤー毎の誘発リストに追加します。

--------------------------------------------------
[10-13]誘発リストに通常効果のアクションがあれば繰り返す
--------------------------------------------------
プレイヤー毎の誘発リストに通常効果を持つアクションがある場合、
順番を次のプレイヤーに渡し、再びプレイヤー毎に誘発リストのアクションをステージに追加します。
