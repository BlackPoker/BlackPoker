...
キーカード条件なしのステージ-クイックアクションを作らない (必須)
--------------------------------------------------------------

**内容**

   ステージに残るステージ-クイックアクションは、必ず明示的なキーカードを指定します。
...
**内容**
   ...
   トリガーが「誘発」のアクションはリゾルブを「即時」、タイミングを「クイック」にする。
...
**内容**
   ...
   「誘発–ステージ–メイン」のアクションは、一度の解決で二重に誘発しないよう条件を設定します。
